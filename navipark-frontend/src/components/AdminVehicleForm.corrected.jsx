...
const AdminVehicleForm = () => {
  ...
  // FIXED: Fetch vehicles on component mount
  useEffect(() => {
    fetchVehicles();
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // FIXED: Use corrected API service
      ...
      if (response.success) {
        ...
        fetchVehicles(); // FIXED: Refresh vehicle list
      } else {
        setMessage(response.error || 'Failed to add vehicle');
...
// FIXED: Delete vehicle function
const deleteVehicle = async (id) => {
  try {
    // Use corrected API service
    const response = await vehiclesAPI.deleteVehicle(id);
    
    if (response.success) {
      // FIXED: Refresh vehicle list
      fetchVehicles();
    } else {
