...
// GET / - Fetch all vehicles (this will be mounted at /api/vehicles)
router.get('/', (req, res) => {
  try {
...
// POST /add - Add a new vehicle (this will be mounted at /api/vehicles/add)
...
// DELETE /:id - Remove a vehicle (this will be mounted at /api/vehicles/:id)
